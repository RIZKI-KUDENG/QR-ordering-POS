                      ...
                      {order.status === "PENDING" && (
                        <Button
                          ...
                          onClick={() => {
                            if (
                              confirm(
                                `Konfirmasi pembayaran (Cash) untuk meja ${order.table?.number}?`
                              )
                            ) {
                              updateStatus({ id: order.id, status: "PAID" });
                            }
                          }}
                        >
                          Terima Bayar
                      ...
                      {order.status === "SERVED" && (
                        <Button
                          ...
                          onClick={() => {
                            if (
                              confirm(
                                `Selesaikan transaksi meja ${order.table?.number}? Meja akan kosong kembali.`
                              )
                            ) {
                              updateStatus({
                                id: order.id,
